...
from ElvarinXMusic import Carbon, app
from ElvarinXMusic.utils.decorators.language import language, languageCB
from ElvarinXMusic.utils.inline.playlist import (
    botplaylist_markup,
    get_playlist_markup,
    warning_markup,
)
...
from ElvarinXMusic.core.mongo import mongodb
...
async def add_playlist(client, message: Message, _):
    ...
    if "https://youtu.be" in query:
        ...
        from ElvarinXMusic import YouTube
...
@app.on_callback_query(filters.regex("elvarin_playlist") & ~BANNED_USERS)
@languageCB
