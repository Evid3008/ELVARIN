...
def stream_markup_timer(_, vidid, chat_id, played, dur):
    ...
    buttons = [
        ...
        [
            InlineKeyboardButton(
                text=" 𝗢𝗪𝗡𝗘𝗥 ", url=f"https://t.me/iq4u8"
            ),
            InlineKeyboardButton(
                text=" 𝗦𝗨𝗣𝗣𝗢𝗥𝗧 ", url=f"https://t.me/iq4us"
            ),
        ],
...
def playlist_markup(_, videoid, user_id, ptype, channel, fplay):
    buttons = [
        [
            InlineKeyboardButton(
                text=_["P_B_1"],
                callback_data=f"elvarinPlaylists {videoid}|{user_id}|{ptype}|a|{channel}|{fplay}",
            ),
            InlineKeyboardButton(
                text=_["P_B_2"],
                callback_data=f"elvarinPlaylists {videoid}|{user_id}|{ptype}|v|{channel}|{fplay}",
            ),
        ],
        [
            InlineKeyboardButton(
...
def panel_markup_clone(_, vidid, chat_id):
    buttons = [
        ...
        [
            InlineKeyboardButton(
                text="✚ ᴘʟᴀʏʟɪsᴛ ✚", callback_data=f"elvarin_playlist {vidid}"
            ),
        ],
    ]
