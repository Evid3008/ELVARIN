...
HELP_16 = """
<b><u>ᴀᴅᴅ ᴍᴇᴍʙᴇʀ ᴄᴏᴍᴍᴀɴᴅs :</b></u> [ᴏɴʟʏ ғᴏʀ ᴏᴡɴᴇʀ]

ᴀᴅᴅ ᴜsᴇʀs ᴛᴏ ɢʀᴏᴜᴘs ʙʏ ᴜsᴇʀɴᴀᴍᴇ ᴏʀ ʟɪɴᴋ.

/addmember <username> <group_id> : ᴀᴅᴅ ᴜsᴇʀ ᴛᴏ ɢʀᴏᴜᴘ ʙʏ ɢʀᴏᴜᴘ ɪᴅ.
**ᴇxᴀᴍᴘʟᴇ:** `/addmember @username -1001234567890`

/addmemberlink <username> <group_link> : ᴀᴅᴅ ᴜsᴇʀ ᴛᴏ ɢʀᴏᴜᴘ ʙʏ ɢʀᴏᴜᴘ ʟɪɴᴋ.
**ᴇxᴀᴍᴘʟᴇ:** `/addmemberlink @username https://t.me/groupname`

/addmemberhelp : sʜᴏᴡ ʜᴇʟᴘ ғᴏʀ ᴀᴅᴅ ᴍᴇᴍʙᴇʀ ᴄᴏᴍᴍᴀɴᴅs.

**📝 ɴᴏᴛᴇs:**
• ᴏɴʟʏ ᴏᴡɴᴇʀ ᴄᴀɴ ᴜsᴇ ᴛʜᴇsᴇ ᴄᴏᴍᴍᴀɴᴅs
• ʙᴏᴛ ᴍᴜsᴛ ʙᴇ ᴀᴅᴍɪɴ ɪɴ ᴛᴀʀɢᴇᴛ ɢʀᴏᴜᴘ
• ʙᴏᴛ ᴍᴜsᴛ ʜᴀᴠᴇ "ᴀᴅᴅ ᴍᴇᴍʙᴇʀs" ᴘᴇʀᴍɪssɪᴏɴ
"""